...
const RegisterSchedule = ({ route, navigation }) => {
    ...
    const loadSchedules = async () => {
        try {
            ...
            const response = await authApi(access_token).get(endpoints['user-appointments']);;
    ...
    const cancelSchedule = async (id, date) => {
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.subject}>DANH SÁCH ĐẶT CHỖ</Text>
            <ScrollView>
                    ...
                    schedules.map((schedule) => (
                        <View key={schedule.id} style={styles.scheduleItem}>
                            ...
                            {schedule.confirmed != true && (
                                <>
                                    <TouchableOpacity style={styles.submitButton} onPress={() => deleteSchedule(schedule.id)}>
                                        <Text style={styles.submitButtonText}>Hủy Đặt Lịch</Text>
                                    </TouchableOpacity>
                                </>
                            )}
